...
|     @@seq_profile                                         | f(2)
|     @@max_spatial_layers_cnt                              | f(2)
|     for ( i = 0; i <\= max_spatial_layers_cnt; i++ )       |
|         @@level[ i ]                                      | f(4)
...
read_block_tx_size is used to read the transform sizes.
...
|          !can_use_previous \|\| is_scaled( RefFrame[0] ) ) {
|         @@use_obmc                                        | S()
