...
| set | cdf |
|:---:|:---:|
| 1   | TileIntraTxTypeSet1Cdf[ txsize_sqr_map[ txSz ] ][ YMode ]
| 2   | TileIntraTxTypeSet2Cdf[ txsize_sqr_map[ txSz ] ][ YMode ]

**inter_tx_type**: the cdf depends on the variable set, as follows:

| set | cdf |
|:---:|:---:|
| 1   | TileInterTxTypeSet1Cdf[ txsize_sqr_map[ txSz ] ]
| 2   | TileInterTxTypeSet2Cdf[ txsize_sqr_map[ txSz ] ]
| 3   | TileInterTxTypeSet3Cdf[ txsize_sqr_map[ txSz ] ]
