...
tile_info ( ) {
    ...
    if ( uniform_tile_spacing_flag ) {
        ...
        for (startSb = 0; startSb < MaxSbCols; startSb += sizeSb) {
          MiColStarts[ i ] = startSb << MAX_MIB_SIZE_LOG2
          i += 1
        }
        ...
        maxTileHeightSb = MaxSbRows >> cm->minLog2TileRows
        ...
        for (startSb = 0; startSb < MaxSbRows; startSb += sizeSb) {
          MiRowStarts[ i ] = startSb << MAX_MIB_SIZE_LOG2
          i += 1
        }
        ...
        for ( i = 0; startSb < MaxSbRows && i < MAX_TILE_ROWS; i++ ) {
            MiRowStarts[ i ] = startSb << MAX_MIB_SIZE_LOG2
            maxHeight = Min(MaxSbRows - startSb, MAX_TILE_WIDTH_SB)
