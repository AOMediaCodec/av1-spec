...
| `COMPOUND_MODE_CONTEXTS`         | 15        | Number of contexts for `compound_mode`
...
| `MV_CLASSES`                     | 12        | Number of values for `mv_class`
| `CLASS0_SIZE`                    | 2         | Number of values for `mv_class0_bit`
| `MV_OFFSET_BITS`                 | 11        | Maximum number of bits for decoding motion vectors
