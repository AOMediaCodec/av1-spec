...
| `MOTION_MODES`                   | 3         | Number of values for motion modes (not including GLOBALWARP)
| `SIMPLE`                         | 0         | Use translation motion compensation
| `OBMC`                           | 1         | Use overlapped block motion compensation
| `LOCALWARP`                      | 2         | Use local warp motion compensation
| `GLOBALWARP`                     | 3         | Use global motion compensation
