...
| `REF_CONTEXTS`                   | 5         | Number of contexts for `single_ref`
| `COMP_REF_CONTEXTS`              | 3         | Number of contexts for `comp_ref` and `comp_bwdref`
...
| `EOB_COEF_CONTEXTS`              | 22        | Number of contexts for `eob_extra`
