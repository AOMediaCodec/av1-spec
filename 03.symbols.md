...
| `SGRPROJ_RST_BITS_HIGHP`         | 4         | Restoration precision bits generated higher than source before projection (high precision)
| `SGRPROJ_RST_BITS_LOWP`          | 3         | Restoration precision bits generated higher than source before projection (low precision)
