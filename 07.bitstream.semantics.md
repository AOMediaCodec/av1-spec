...
available if show_existing_frame is 1. It is a requirement of bitstream conformance that whenever frame_to_show_map_idx is read, RefValid[ frame_to_show_map_idx ] is equal to 1.
