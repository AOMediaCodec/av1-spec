...
AllLossless is computed by checking that all segments are lossless.
If the final value of AllLossless (after uncompressed_header has been parsed) is equal to 1,
it is a requirement of bitstream conformance that UpscaledWidth is equal to FrameWidth.
