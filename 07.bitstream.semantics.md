...
**seq_tier[ i ]** specifies the tier that the coded video sequence conforms to when operating point i is selected. seq_tier[ i ] equal to 0 indicates the Main tier. seq_tier[ i ] equal to 1 indicates the High tier.
