...
is invoked the following takes place:
  ...
  * The cumulative distribution function arrays are reset to default values as follows:
    ...
    * SwitchableInterpCdf is set to a copy of default_switchable_interp_cdf
    
    * JointCdf is set to a copy of default_joint_cdf
...
the probability tables and cumulative distribution function arrays are saved into frame context number ctx in the range 0
