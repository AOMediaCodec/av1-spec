...
**enable_ref_frame_mvs** equal to 1 indicates that the can_use_previous
syntax element may be present.
enable_ref_frame_mvs equal to 0 indicates that the can_use_previous
syntax element will not be present. 
...
enable_cdef equal to 0 specifies that loop restoration filtering is disabled.
