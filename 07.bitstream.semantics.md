...
**temporal_group_switching_up_point_flag[ i ]** is set to 1 if subsequent (in decoding order) pictures with
...
**temporal_group_reserved_bit[ i ]** must be set to 0 and be ignored by decoders.
