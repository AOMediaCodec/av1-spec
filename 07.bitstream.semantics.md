...
a specific layer  (value 1), or not (value 0). Metadata OBU types may or may not be layer-specific, depending on the metadata type. The table in Section 6.7.1 specifies which types are layer-specific and which are not.
...
| 1              | METADATA_TYPE_HDR_CLL       | 0
| 2              | METADATA_TYPE_HDR_MDCV      | 0
| 3              | METADATA_TYPE_SCALABILITY   | 0
| 4              | METADATA_TYPE_ITUT_T35      | application-specific
| 5              | METADATA_TYPE_TIMECODE      | 0
