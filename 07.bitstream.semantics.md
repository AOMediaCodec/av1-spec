...
Scalability structure metadata, if it is present,
must occur after the sequence header and before the first frame header in the coded video sequence.
...
video bitstream without have to decode individual frames.
{:.alert .alert-info }
