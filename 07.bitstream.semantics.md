...
a specific layer  ("Y"), or not ("N"). Metadata OBU types may or may not be layer-specific, depending on the metadata type. The table in Section 6.7.1 specifies which types are layer-specific and which are not.
