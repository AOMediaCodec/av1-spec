...
**dq_type** specifies which set of dequantization profiles to use. It can take the following
values:

| dq_type | Name of dq_type
| ------- | ------------------
| 0       | DQ_MULT
| 1       | DQ_MULT_OFFSET1
| 2       | DQ_MULT_OFFSET2
...
**clip_to_restricted_range** equal to 1 specifies that the final sample values should be constrained to the studio swing ranges (see the semantics for color_range for an explanation of studio swing).
clip_to_restricted_range equal to 0 specifies that the final sample values are allowed the full swing ranges.
