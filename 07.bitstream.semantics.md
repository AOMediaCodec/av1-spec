...
coded video bitstream without having to decode individual frames. 
{:.alert .alert-info }

Scalability metadata should be placed between the first sequence header and the first frame header of a coded video sequence. The information present in a scalability metadata OBU applies to the entire coded video sequence it is contained. Redundant copies of a scalability metadata OBU may occur in any temporal unit of a coded video sequence.
