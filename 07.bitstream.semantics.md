...
**Note:** It is a requirement of bitstream conformance that comp_mode is
equal to SINGLE_REFERENCE for any block where seg_feature_active(SEG_LVL_SKIP) is equal to 1.
