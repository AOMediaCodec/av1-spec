...
The following ordered steps apply:
  ...
  2. Invoke the 2D inverse transform block process defined in [section 8.7.2][]
...
The filter size process specified in [section 8.8.2][] is invoked with the inputs
...
The adaptive filter strength process specified in [section 8.8.3][] is invoked with
the inputs row and col, and the output assigned to the variables
lvl, limit, blimit, and thresh.
      
If lvl is equal to 0, the adaptive filter strength process specified in [section 8.8.3][] is invoked with
...
For the variable i taking values from 0 to MI_SIZE - 1, the following applies:
  ...
  * If applyFilter is equal to 1 and lvl is greater than zero, the sample
      filtering process specified in [section 8.8.5][] is invoked with the input variable
...
The output variable lvl is derived as follows:
  ...
  * The adaptive filter strength selection process specified in [section 8.8.4][] is invoked, with segment,
