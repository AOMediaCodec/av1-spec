...
in the inter block mode info syntax described in [section 6.4.19][].
...
If filterY is equal to 1 or filterUV is equal to 1, the CDEFdirection process specified in [section 8.10.2][] is invoked with r and c as inputs, and the outputs assigned to variables yDir and var.
